  ...
  return (
    <div className="flex flex-end">
      <footer className=" bg-[#1a1919] p-8 md:p-20 lg:p-28">
        <div className="grid gap-5 md:grid-cols-6">
          <nav className="col-span-1 space-y-5 md:col-span-2">
            ...
            <p className="font-[manrope] text-base leading-7 text-[#ffffffb3]">
              Building bridges between talent and opportunity — CareerHub is
        ...
        <div className="mt-14 flex flex-col justify-between lg:flex-row">
          <p className="font-[inter] text-sm font-semibold text-[#ffffff66]">
            @2025 CareerHub. All Rights Reserved
          </p>
          <p className="font-[inter] text-sm font-bold text-[#ffffff66]">
